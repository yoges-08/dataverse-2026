  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-16 overflow-hidden">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center pt-8 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero-glow-pulse absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-gradient-to-tr from-violet-600/40 via-fuchsia-500/30 to-cyan-500/40 rounded-full blur-[140px] pointer-events-none"></div>
