...
class MockStore {
  ...
  async init() {
    console.log('⚡ Initializing DATAVERSE In-Memory Data Engine...');
    ...
    // Users
    const uAdmin = { _id: 'u1', name: 'Dr. R. K. Varma (Convener)', email: 'aidssymposium2026@gmail.com', password: adminPass, role: 'super_admin', isEmailVerified: true };
    ...
    this.events = [
      {
        ...
        description: 'QuizEE is the flagship technical quiz competition covering Data Structures, Algorithms, AI, Web Technologies, and Logical Reasoning.',
