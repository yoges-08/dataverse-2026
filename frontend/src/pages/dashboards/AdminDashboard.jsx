...
export default function AdminDashboard() {
  ...
  const [newEvent, setNewEvent] = useState({
    title: '', category: 'Technical', tagline: '', description: '', rules: '', venue: '', date: '2026-09-15', time: '10:00 AM', registrationDeadline: '2026-09-12', maxParticipants: 100, facultyName: '', facultyPhone: '', studentName: '', studentPhone: '', firstPrize: '', secondPrize: '', thirdPrize: ''
  });
