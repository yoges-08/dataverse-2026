        ...
        <>
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800">
            ...
            <p className="text-xs text-slate-400 mb-4">
              These are students registered for this event from your college who are not yet
            ...
            {isFull ? (
              ...
              <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-xs text-slate-400">
                ...
                from your college{myLanguage ? ` with ${myLanguage} selected` : ''}, and not already on another team.
              </div>
            ) : (
          ...
          <div className="p-4 rounded-xl bg-slate-900/50 border border-slate-800 text-[11px] text-slate-400 flex items-start space-x-2.5">
            ...
            <span>
              Only students registered for this event from the same college can be added.
